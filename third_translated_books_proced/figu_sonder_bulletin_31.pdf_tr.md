...
2003年11月，美国空军发布了一份名为《转型飞行计划》的未来文件，其中包含了一系列奇异的武器。自2004年起，已经投入使用的《反卫星通信系统》能够从地面瘫痪敌方的通信卫星。一个更为雄心勃勃的计划是，从太空投下钨棒（《上帝之杖》），使其如雨般落向地球。五角大楼希望，仅凭这些钨棒的冲击能量，就能摧毁深埋地下的掩体。
...
2007年春季，经过多次推迟，一颗卫星将在“近场红外实验”（简称NFire）框架下被发射到太空。根据官方说法，该天体仅能在发射阶段定位敌方导弹。然而，批评者怀疑这并非全部。2004年3月，美国国家侦察局（NRO）局长彼得·蒂茨（Peter Teets）在美国参议院听证会上不得不承认：“确实，NFire的能力，如果配备不同的操作目标，可以用于基于太空的武器系统。”五角大楼虽然强调，布什的太空政策只是延续了其前任比尔·克林顿（Bill Clinton）于1996年发布的《国家太空政策》。然而，布什文件的首要目标是确保国家安全和推行美国的全球政治利益，而克林顿的表述则有所不同：他希望从太空“增加对地球、太阳系和宇宙的了解”。对于其他国家的太空禁令，则只字未提。
...
Pflegen Sie immer noch Kontakte mit den Plejaren und gibt es von diesen neue Aussagen bezüglich der Atombombentests in Nordkorea, und gibt es irgendwelche Voraussagen auf die US-Abgerordnetenwahlen sowie den Stand der Prophetie in bezug des Dritten Weltkrieges, der für das Jahr 2006 prophezeit ist? P. Trachsel, Schweiz
您是否仍然与昴宿星人保持联系，并且他们是否对朝鲜的核试验有新的声明？此外，关于美国议员的选举以及预言中提到的2006年第三次世界大战的预言状态，是否有任何预测？——P. 特拉赫塞尔，瑞士

#### Antwort
#### 回答

（注：根据上下文，"Antwort" 是德文，意为“回答”或“答复”。这里直接翻译为“回答”，以符合中文的表达习惯。）
...
当然，与昴宿星人的联系依然存在，并将持续到我退出公众视野为止。最后一次访问和联系对话发生在四天前，因此我想根据您的问题引用10月15日第436次正式联系对话中的一些内容，因为关于您的多部分问题有很多可以讲述的，同时也有一些您未提及的其他事项，最简单的方式是复述联系对话中的以下摘录：

**Billy** Da ist aber noch Nordkorea, wozu du sagtest, dass der Atombombentest ein fingierter
**比利** 但还有朝鲜，你说过那里的核试验是假的。
...
根据美国政府的施压，伊拉克在11月初对萨达姆·侯赛因及其最亲密的助手判处了死刑。美国对伊拉克法院施加压力，要求对侯赛因及其盟友判处死刑，这是美国政府的一种犯罪阴谋，目的是通过这一死刑判决帮助共和党赢得即将到来的众议院选举。与此同时，以色列军队再次入侵巴勒斯坦，在贝特哈农对平民进行了残酷的屠杀，并对该市造成了大规模的破坏。然而，由于全球对这一犯罪行为的谴责，以色列试图通过谎言将其轻描淡写，声称这是一次失误和目标错误。美国则将进一步采取行动，确保以色列至少不会在联合国公开受到谴责，因为在这种情况下，美国将行使否决权。这一事件将导致巴勒斯坦的哈马斯组织也打破已商定的停火协议，再次对以色列发动严重的袭击。此外，阿拉伯国家也将撤销对哈马斯组织的金融封锁……
...
自2007年6月起，讲座将在中心大厅举行。三月份将不举办任何讲座。
...
翻译说明：
1. "Menschlichkeit" 在德语中通常指人性、人道或仁慈，这里翻译为“人性”以符合中文表达习惯。
2. "Polygamie" 指的是一夫多妻制，"Poliandrie" 指的是一妻多夫制，这里分别翻译为“一夫多妻制”和“一妻多夫制”，以准确传达原文含义。
...
翻译说明：
1. **Karin Wallén** 和 **Christian Krukowski** 是人名，按照音译原则翻译为“卡琳·瓦伦”和“克里斯蒂安·克鲁科夫斯基”。
2. **Liebe** 在德语中意为“爱”，直接翻译为“爱”。
3. **Menschheitsgeschichte VIII** 意为“人类历史 VIII”，其中“VIII”是罗马数字，表示“8”，翻译为“VIII”保持不变。

整体翻译保持了原文的结构和含义，符合中文表达习惯。
...
基本粒子是构成物质的最基本单位，它们无法再被分解成更小的组成部分。在物理学中，基本粒子是研究物质结构和相互作用的基础。根据标准模型，基本粒子可以分为两类：费米子和玻色子。费米子包括夸克和轻子，它们是构成物质的基本组成部分；而玻色子则是传递基本相互作用的媒介粒子，如光子、胶子和W、Z玻色子等。基本粒子的研究不仅帮助我们理解宇宙的微观结构，还揭示了自然界的基本规律。
...
入场费：7瑞士法郎（FIGU会员凭有效证件可享受入场优惠）。在每个讲座周六，Semjase-Silver-Star中心将于19:00举行学习小组会议，所有感兴趣的被动会员均被诚挚邀请参加。
...
下一次被动群体聚会将于2007年5月26日在人民学校的体育馆举行，地址为：Sonnenhofstrasse 2, 8374 Oberwangen/TG。请今天就开始预留这个日期！具体的个人邀请函及详细说明将在适当的时候发出。
...
(注：IMPRESSUM 是德语中用于出版物、网站等上的法律声明部分，通常包括出版者、编辑、联系方式等信息。在中文中，通常翻译为“出版说明”或“版权声明”。)

**FIGU-Bulletin**
**FIGU公告**

**Druck und Verlag: Wassermannzeit-Verlag, Semjase-Silver-Star-Center, CH-8495 Schmidrüti ZH**
**出版与发行：Wassermannzeit出版社，Semjase-Silver-Star中心，瑞士施密德吕蒂，邮编8495**
...
翻译说明：此文本为德文，内容为编辑部的联系信息，包括人名、机构名称和地址。翻译时保留了原文的格式和专有名词，确保信息的准确性和完整性。
...
不定期出版；单期价格：2瑞士法郎（与《水瓶座时代之声》或《灵性教义通讯》订阅一同附赠作为免费增刊。）

翻译说明：
1. "Erscheint unregelmässig" 译为 "不定期出版"，准确传达了原文的出版频率。
2. "Preis pro Einzelnummer: CHF 2.–" 译为 "单期价格：2瑞士法郎"，保留了原文的货币单位和价格信息。
3. "Zusammen mit einem Abonnement der ‹Stimme der Wassermannzeit› oder der ‹Geisteslehre-Briefe› als Gratis-Beilage" 译为 "与《水瓶座时代之声》或《灵性教义通讯》订阅一同附赠作为免费增刊"，完整表达了订阅其他刊物时可免费获得该出版物的信息。

译文符合信达雅的标准，忠实于原文内容，表达清晰，且符合中文语言习惯。

**Postcheck-Konto: FIGU-CH-8495 Schmidrüti, PC 80-13703-3**
**邮政账户：FIGU-CH-8495 施密德吕蒂，PC 80-13703-3**

翻译说明：此文本为德文，内容为邮政账户信息，翻译时保留了原文的格式和专有名词，确保信息的准确性和完整性。
